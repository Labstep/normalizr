...
function denormalizeImmutable(e, t, r) {
  return Object.keys(e).reduce(function(t, n) {
    var i = '' + n;
    return t.has(i) ? t.set(i, r(t.get(i), e[i])) : t;
  }, t);
}
...
var getDefaultGetId = function(e) {
  ...
  EntitySchema = (function() {
    function e(e, t, r) {
      if ((void 0 === t && (t = {}), void 0 === r && (r = {}), !e || 'string' != typeof e))
    ...
    return (
      (t.define = function(e) {
        this.schema = Object.keys(e).reduce(function(t, r) {
          var n,
            i = e[r];
          return _objectSpread({}, t, (((n = {})[r] = i), n));
        }, this.schema || {});
      }),
      (t.getId = function(e, t, r) {
        return this._getId(e, t, r);
      }),
      (t.merge = function(e, t) {
        return this._mergeStrategy(e, t);
      }),
      (t.normalize = function(e, t, r, n, i, o) {
        var a = this;
        if (
          o.some(function(t) {
            return t === e;
          ...
          return this.getId(e, t, r);
        o.push(e);
        var u = this._processStrategy(e, t, r);
        return (
  ...
  PolymorphicSchema = (function() {
    ...
    return (
      ...
      (t.getSchemaAttribute = function(e, t, r) {
        return !this.isSingleSchema && this._schemaAttribute(e, t, r);
      }),
      (t.inferSchema = function(e, t, r) {
        if (this.isSingleSchema) return this.schema;
        var n = this.getSchemaAttribute(e, t, r);
        return this.schema[n];
      }),
      (t.normalizeValue = function(e, t, r, n, i, o) {
        var a = this.inferSchema(e, t, r);
        if (!a) return e;
        var u = n(e, t, r, a, i, o);
        return this.isSingleSchema || null == u ? u : { id: u, schema: this.getSchemaAttribute(e, t, r) };
      }),
      (t.denormalizeValue = function(e, t) {
        var r = isImmutable(e) ? e.get('schema') : e.schema;
        return this.isSingleSchema || r
          ? t((isImmutable(e) ? e.get('id') : e.id) || e, this.isSingleSchema ? this.schema : this.schema[r])
          : e;
      }),
      _createClass(e, [
        {
  ...
  UnionSchema = (function(e) {
    ...
    var r = t.prototype;
    return (
      (r.normalize = function(e, t, r, n, i, o) {
        return this.normalizeValue(e, t, r, n, i, o);
      }),
      (r.denormalize = function(e, t) {
    ...
    return (
      (r.normalize = function(e, t, r, n, i, o) {
        ...
        return Object.keys(e).reduce(function(t, r, u) {
          var c,
            s = e[r];
          return null != s ? _objectSpread({}, t, (((c = {})[r] = a.normalizeValue(s, e, r, n, i, o)), c)) : t;
        }, {});
      }),
      (r.denormalize = function(e, t) {
        var r = this;
        return Object.keys(e).reduce(function(n, i) {
          var o,
            a = e[i];
          return _objectSpread({}, n, (((o = {})[i] = r.denormalizeValue(a, t)), o));
        }, {});
      }),
      t
    );
  ...
  normalize = function(e, t, r, n, i, o, a) {
    return (
      (e = validateSchema(e)),
      getValues(t).map(function(t, u) {
        return i(t, r, n, e, o, a);
      })
    );
  },
  denormalize = function(e, t, r) {
    return (
      (e = validateSchema(e)),
      t && t.map
        ? t.map(function(t) {
  ...
  ArraySchema = (function(e) {
    ...
    return (
      (r.normalize = function(e, t, r, n, i, o) {
        ...
        return getValues(e)
          .map(function(e, u) {
            return a.normalizeValue(e, t, r, n, i, o);
          })
          .filter(function(e) {
            return null != e;
          });
  ...
  _normalize = function(e, t, r, n, i, o, a) {
    var u = _objectSpread({}, t);
    return (
      Object.keys(e).forEach(function(r) {
        var n = e[r],
          c = i(t[r], t, r, n, o, a);
        null == c ? delete u[r] : (u[r] = c);
      }),
      u
    );
  },
  _denormalize = function(e, t, r) {
    if (isImmutable(t)) return denormalizeImmutable(e, t, r);
    var n = _objectSpread({}, t);
    return (
      Object.keys(e).forEach(function(t) {
        null != n[t] && (n[t] = r(n[t], e[t]));
      }),
      n
    );
  },
  ...
  visit = function e(t, r, n, i, o, a) {
    return 'object' == typeof t && t
      ? 'object' != typeof i || (i.normalize && 'function' == typeof i.normalize)
        ? i.normalize(t, r, n, e, o, a)
        : (Array.isArray(i) ? normalize : _normalize)(i, t, r, n, e, o, a)
      : t;
  },
    ...
    return function e(n, i) {
      return 'object' != typeof i || (i.denormalize && 'function' == typeof i.denormalize)
        ? null == n
          ...
          ? unvisitEntity(n, i, e, r, t)
          : i.denormalize(n, e)
        : (Array.isArray(i) ? denormalize : _denormalize)(i, n, e);
    };
  },
  getEntities = function(e) {
    ...
    return function(r, n) {
      var i = n.key;
      return 'object' == typeof r ? r : t ? e.getIn([i, r.toString()]) : e[i] && e[i][r];
    };
  },
  denormalize$1 = function(e, t, r) {
    if (void 0 !== e) return getUnvisit(r)(e, t);
  };
