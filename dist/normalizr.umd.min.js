!(function(e, t) {
  ...
  var a = function(e) {
    ...
    s = (function() {
      ...
      return (
        ...
        (t.normalizeValue = function(e, t, n, r, i, o) {
          ...
          if (!u) return e;
          var c = r(e, t, n, u, i, o);
          return this.isSingleSchema || null == c ? c : { id: c, schema: this.getSchemaAttribute(e, t, n) };
        }),
        (t.denormalizeValue = function(e, t) {
          var n = u(e) ? e.get('schema') : e.schema;
          return this.isSingleSchema || n
            ? t((u(e) ? e.get('id') : e.id) || e, this.isSingleSchema ? this.schema : this.schema[n])
            : e;
        }),
        n(e, [
          {
    ...
    l = (function(e) {
      ...
      var n = t.prototype;
      return (
        (n.normalize = function(e, t, n, r, o, u) {
          var c = this;
          return Object.keys(e).reduce(function(t, n, a) {
            var f,
              s = e[n];
            return null != s ? i({}, t, (((f = {})[n] = c.normalizeValue(s, e, n, r, o, u)), f)) : t;
          }, {});
        }),
        (n.denormalize = function(e, t) {
          var n = this;
          return Object.keys(e).reduce(function(r, o) {
            var u,
              c = e[o];
            return i({}, r, (((u = {})[o] = n.denormalizeValue(c, t)), u));
          }, {});
        }),
        t
      );
    ...
    p = function(e, t, n, r, i, o, u) {
      return (
        (e = y(e)),
        m(t).map(function(t, c) {
    ...
    b = function(e, t, n, r, o, u, c) {
      var a = i({}, t);
      return (
        Object.keys(e).forEach(function(n) {
          var r = e[n],
            i = o(t[n], t, n, r, u, c);
          null == i ? delete a[n] : (a[n] = i);
        }),
        a
      );
    },
    g = function(e, t, n) {
      if (u(t)) return c(e, t, n);
      var r = i({}, t);
      return (
    ...
    k = function e(t, n, r, i, o, u) {
      return 'object' == typeof t && t
        ? 'object' != typeof i || (i.normalize && 'function' == typeof i.normalize)
          ? i.normalize(t, n, r, e, o, u)
          : (Array.isArray(i) ? p : b)(i, t, n, r, e, o, u)
        : t;
    },
    j = {
      Array: v,
    ...
    z = function(e) {
      ...
      return function e(r, o) {
        return 'object' != typeof o || (o.denormalize && 'function' == typeof o.denormalize)
          ? null == r
            ? r
            : o instanceof f
            ? (function(e, t, n, r, o) {
                ...
                if ((o[t.key] || (o[t.key] = {}), !o[t.key][e])) {
                  var a = u(c) ? c : i({}, c);
                  o[t.key][e] = a;
                  var f = t.denormalize(a, n);
                  o[t.key][e] = t.EntityClass ? new t.EntityClass(f) : f;
                }
                return 'Object' === o[t.key][e].constructor.name && t.EntityClass
                  ? new t.EntityClass(o[t.key][e])
                  : o[t.key][e];
              })(r, o, e, n, t)
            : o.denormalize(r, e)
          : (Array.isArray(o) ? d : g)(o, r, e);
      };
    },
    O = function(e) {
      var t = u(e);
      ...
      var n = {},
        r = (function(e) {
          return function(t, n, r, i, o) {
            ...
            u in e || (e[u] = {});
            var a = e[u][c];
            e[u][c] = a ? t.merge(a, n) : n;
          };
        })(n);
      return { entities: n, result: k(e, e, null, t, r, {}) };
    }),
    (e.schema = j),
